...
/**
 * Set the tenant ID to include as X-Tenant-ID in every request.
 * Pass `null` to clear it (defaults to no header, which the API treats as tenant 1).
 */
...
export async function customFetch<T = unknown>(
  ...
  // Attach tenant ID header when configured and not already present.
